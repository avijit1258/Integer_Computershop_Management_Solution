        ...
        <div class="col-sm-offset-2 col-sm-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('sub_catagory') }}" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
                            ...
                            <tbody>
                                @foreach ($sub_catagories as $sub_catagory)
                                    <tr>
                                        ...
                                        <td class="table-text"><div>{{ $sub_catagory->catagory_id }}</div></td>


                                        <!-- SubCatagory Delete Button -->
                                        <td>
                                            <form action="{{url('sub_catagory/' . $sub_catagory->id)}}" method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
