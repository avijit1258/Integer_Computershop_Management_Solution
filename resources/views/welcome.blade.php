...
<head>
    ...
    <title>Integer Computer Managment System</title>
...
<body >
    ...
    <div class="flex-center position-ref full-height">
        ...
        <div class="top-right links">
            @if (Auth::check())
            <a href="{{ url('/catagories') }}"><font color="white" size="16px">
               Store 
            </font></a>
            @else
            <a href="{{ url('/login') }}">
        ...
        <div class="content">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <img src="image/welcome.jpg" alt="Chania">
              </div>

              <div class="item">
                  <img src="image/printer.jpg" alt="Chania">
              </div>

              <div class="item">
                  <img src="image/apple.jpg" alt="Flower">
              </div>
